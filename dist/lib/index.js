...
const webrtc_signal_http_ts_1 = require("webrtc-signal-http-ts");
...
module.exports = (opts) => {
    const app = express();
    let peerList = new webrtc_signal_http_ts_1.PeerList();
    ...
    if (!optIsFalsey(opts.authEnabled)) {
        const b2cStrategy = new passport_azure_ad_1.BearerStrategy({
        ...
        passport.use(new passport_azure_ad_1.BearerStrategy({
    ...
    const signalRouter = webrtc_signal_http_ts_1.signalRouterCreator(Object.assign({}, opts, { 
